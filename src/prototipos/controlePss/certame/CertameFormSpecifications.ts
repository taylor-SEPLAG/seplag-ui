...
export const certameFormTabSpecifications: Record<string, SpecificationMetadata> = {
 ...
 "Vagas": spec(
  "PSS-CERT-FRM-TAB-004", "Vagas",
  "Aba com o bloco \"Cargos e vagas\". A sub-lista de Fases permanece na aba Cronograma.",
  "RN-10 (código de referência fixo '001'), RN-14 (cargo sempre selecionado do catálogo do Quadro de Vagas, para Concurso Público e PSS; ao menos um cargo/vaga é exigido para salvar) e RN-17 (vínculo automático e interno com o Quadro de Vagas do Controle de Vagas > Quadro Autorizado, por cargo — rastreabilidade Edital → Quadro de Vagas → Gestão de Ingresso; sem campo próprio no formulário). Carreira é exclusiva do Concurso Público (RN-01/RN-16), não exibida para PSS. Cada cargo/vaga pode reservar vagas para um ou mais tipos ativos de cota (RN-08), com a soma das reservas limitada à quantidade de vagas do cargo.",
  "Certame.cargos.", "CargoVagaCertame[]", "formulário com grade de vagas",
 ),
 "Documentos": spec(
...
export const certameFormBlockSpecifications = {
 ...
 quadroVagasVinculado: spec("PSS-CERT-FRM-BLC-005", "Quadro de Vagas vinculado ao cargo", "Vincular automaticamente o cargo selecionado ao Quadro de Vagas (código e versão) — vínculo interno, sem campo próprio no formulário de vaga (o campo somente leitura \"Quadro de vagas\" foi removido do modal para Concurso Público e PSS).", "RN-17 — vínculo automático, sem escolha manual; garante rastreabilidade Edital → Quadro de Vagas → Gestão de Ingresso mesmo sem exibição na tela. Vínculo em Controle de Vagas > Quadro Autorizado.", "CARGOS_CADASTRADOS (quadroCodigo/quadroVersao) e CargoVagaCertame.", "string", "vínculo interno, sem representação visual no formulário"),
