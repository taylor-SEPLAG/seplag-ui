...
export const painelPssBlockSpecifications = {
 ...
 proximosPrazos: spec("PSS-PAINEL-BLC-002", "Próximos prazos", "Lista os prazos de prestação de contas ao TCE-MT mais próximos de vencer entre os certames filtrados.", "RN-15 — prazo de 48h de prestação de contas contado a partir da data de efeito da situação mais recente do certame.", "Certame.historicoSituacoes[].prazoPrestacaoContas, ordenado do mais próximo ao mais distante.", "PrazoPainel[]", "lista"),
