...
export const painelPssBlockSpecifications = {
 ...
 cotasResumo: spec("PSS-PAINEL-BLC-003", "Cotas e vagas", "Resumo do total de vagas, vagas PCD/PNE e certames com cota, seguido da lista de cotas cadastradas por certame.", "RN-08 — cotas (PCD/PPP/Indígenas/Quilombolas/TEA) são cadastradas por certame; a coluna \"Vagas reservadas\" soma, entre os cargos do certame, as vagas cujo CargoVagaCertame.tipoCota corresponde ao tipo da cota da linha.", "Certame.cotas[], Certame.cargos[].tipoCota/quantidadeCota.", "CotaCertame[]", "resumo + lista"),
