...
describe("menus do Controle de Vagas", () => {
  ...
  it("usa a evolução legal existente na rota de nova versão", () => {
    const result = render(<MemoryRouter initialEntries={["/prototipos/sigep/backlog/quadro-autorizado/1/nova-versao"]}><Routes><Route path="/prototipos/sigep/backlog/quadro-autorizado/:id/nova-versao" element={<QuadroAutorizadoContent />} /></Routes></MemoryRouter>);
  ...
  it("renderiza a rota de nova autorização", () => {
    const result = render(<MemoryRouter initialEntries={["/prototipos/sigep/backlog/quadro-autorizado/novo"]}><QuadroAutorizadoContent /></MemoryRouter>);
