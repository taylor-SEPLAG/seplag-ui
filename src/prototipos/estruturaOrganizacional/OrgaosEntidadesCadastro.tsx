...
const autoLabel = (texto: string) => (
  <span className="orgao-auto-label">
    {texto}
    <BadgeSeplag label="AUTOMÁTICO" size="xs" color="#0870b6" bg="#e8f5ff" />
  </span>
);
...
export function OrgaosEntidadesCadastro({ tipoInicial = "orgao", onBack }: Readonly<OrgaosEntidadesCadastroProps>) {
  ...
  const { control, watch, setValue } = useForm<Dados>({
    defaultValues: {
      ...
      aplic: "Administração",
      situacao: "Ativa",
      classificacaoTributaria: "85 - Ente Federativo",
      siafi: "000001",
      registroEletronico: "Não aplicável",
      desoneracao: "Não aplicável",
  ...
  const abas: { id: Aba; label: string; descricao: string }[] = [
    ...
    },
    {
      ...
      descricao: "Endereço e canais institucionais.",
    },
    {
      id: "responsavel",
      label: "Responsável e Dados Bancários",
      descricao: "Responsável vigente e conta bancária.",
    },
    {
      id: "integracoes",
      label: "Integrações",
