...
const vagasElegiveisRedistribuicao =
  ...
  return (
    <section className="prototype-comissionados-legal-card">
      {versaoAgendada && (
        <MensagemSeplag
          severity="warning"
...
<form onSubmit={simular}>
        <section className="prototype-comissionados-legal-version-context">
          ...
          <dl className="prototype-comissionados-legal-version-summary">
        ...
        <BaseLegalVinculada
          className="prototype-comissionados-legal-documents"
        ...
        />
        <div className="prototype-comissionados-legal-types prototype-comissionados-legal-types-current">
        ...
        {tipo === "ATUALIZACAO_BASE_LEGAL" && (
          <section className="prototype-comissionados-legal-organization-change">
            <MensagemSeplag
              severity="info"
        ...
        {tipo === "DISTRIBUICAO" && (
          <section className="prototype-comissionados-legal-distribution-version">
            <header>
              <div>
            ...
            <div className="prototype-comissionados-legal-distribution-summary-inline">
            ...
            <div className="prototype-comissionados-legal-distribution-head">
              <span>Órgão *</span>
            ...
            {linhasDistribuicao
              ...
              .map((item) => (
              <div
                className={`prototype-comissionados-legal-distribution-row${item.fixa ? " is-locked" : ""}`}
                key={`${item.fixa ? "atual" : "nova"}-${item.id}-${item.orgao || "vazio"}`}
              >
                <label>
                  <span>Órgão *</span>
                  {item.fixa ? (
                    <div className="prototype-comissionados-legal-distribution-locked-orgao">
                    ...
                    <Dropdown
                      ...
                      showClear
                      filter
                      className="prototype-comissionados-legal-distribution-dropdown"
                      onChange={(event) =>
                ...
                <div>
                  <span>Ações</span>
                  {item.fixa ? (
                    <span className="prototype-comissionados-legal-distribution-locked-action">Fixo</span>
                  ) : (
                    <BotaoIconSeplag
                      type="button"
        ...
        {tipo === "REDISTRIBUICAO" && redistribuicaoIndisponivel && (
          <section className="prototype-comissionados-legal-redistribution-version">
            <MensagemSeplag
              severity="info"
        ...
        {tipo === "REDISTRIBUICAO" && !redistribuicaoIndisponivel && (
          <section className="prototype-comissionados-legal-redistribution-version">
            ...
            <div className="prototype-comissionados-legal-redistribution-route">
              <article>
                <header>
                  <span className="prototype-comissionados-legal-redistribution-icon is-origin">
              ...
              <div className="prototype-comissionados-legal-redistribution-arrow" aria-hidden="true">
                <i className="pi pi-arrow-right" />
              </div>
              <article>
                <header>
                  <span className="prototype-comissionados-legal-redistribution-icon is-destination">
            ...
            <div className="prototype-comissionados-legal-redistribution-quantity">
              <NumberFieldSeplag
        ...
        {tipo === "REDUCAO" && (
          <section className="prototype-comissionados-legal-reduction-allocation">
            <header>
              <div>
        ...
        {tipo === "TRANSFORMACAO" && (
          <section className="prototype-comissionados-legal-reduction-allocation prototype-comissionados-legal-transformation-allocation">
            <header>
              <div>
            ...
            <div className="prototype-comissionados-legal-transformation-destination-field">
              <DropdownFieldSeplag
            ...
            {quadroDestino ? (
              <div className="prototype-comissionados-legal-transformation-target">
        ...
        {tipo === "EXTINCAO_PROGRESSIVA" && (
          <section className="prototype-comissionados-legal-extinction-guidance">
            <MensagemSeplag
              severity="info"
        ...
        )}        <div className="prototype-comissionados-legal-fields prototype-comissionados-legal-library-fields">
          <DateFieldSeplag
            name="dataEfeito"
            control={operacaoControl}
        ...
        />
        {tipo === "DISTRIBUICAO" && (
          <section className="prototype-comissionados-legal-distribution-availability">
            <article>
              <span>Já distribuídas</span>
        ...
        <div className="prototype-comissionados-legal-simulate-action">
          <BotaoSeplag
      ...
      {tipo === "DISTRIBUICAO" && distribuicaoSimulada && (
        <div className="prototype-comissionados-legal-result">
          <header>
            <div>
          ...
          <section className="prototype-comissionados-legal-transformation-balance">
          ...
          <div className="prototype-comissionados-legal-result-kpis">
            <article>
              <span>Vagas elegíveis</span>
          ...
          <section className="prototype-comissionados-legal-distribution-simulation">
            <div>
      ...
      {resultado && tipo !== "ATUALIZACAO_BASE_LEGAL" && (
        <div className="prototype-comissionados-legal-result">
          ...
          {tipo !== "TRANSFORMACAO" && tipo !== "ATUALIZACAO_BASE_LEGAL" && <div className="prototype-comissionados-legal-result-kpis">
            {tipo === "AMPLIACAO" ? (
              <>
      ...
      {confirmacaoAberta && (resultado || distribuicaoSimulada || redistribuicaoSimulada) && (
        <div
          className="prototype-comissionados-legal-confirm-backdrop"
          role="presentation"
          onMouseDown={() => setConfirmacaoAberta(false)}
        >
          <section
            className="prototype-comissionados-legal-confirm"
            role="dialog"
            aria-modal="true"
