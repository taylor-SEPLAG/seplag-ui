...
export function BaseLegalVinculada({
  ...
  return (
    <section className={`prototype-residentes-base-legal-card ${className}`.trim()}>
      <header className="prototype-residentes-base-legal-card__header">
      ...
      <div className="prototype-residentes-base-legal-card__content">
