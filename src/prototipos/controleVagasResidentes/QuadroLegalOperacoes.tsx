...
const vagasElegiveisRedistribuicao =
  ...
  return (
    <section className="prototype-residentes-legal-card">
      {versaoAgendada && (
        <MensagemSeplag
          severity="warning"
...
<form onSubmit={simular}>
        <section className="prototype-residentes-legal-version-context">
          ...
          <dl className="prototype-residentes-legal-version-summary">
        ...
        <BaseLegalVinculada
          className="prototype-residentes-legal-documents"
        ...
        />
        <div className="prototype-residentes-legal-types prototype-residentes-legal-types-current">
        ...
        {tipo === "ATUALIZACAO_BASE_LEGAL" && (
          <section className="prototype-residentes-legal-organization-change">
            <MensagemSeplag
              severity="info"
        ...
        {tipo === "DISTRIBUICAO" && (
          <section className="prototype-residentes-legal-distribution-version">
            <header>
              <div>
            ...
            <div className="prototype-residentes-legal-distribution-summary-inline">
            ...
            <div className="prototype-residentes-legal-distribution-head">
              <span>Órgão *</span>
            ...
            {linhasDistribuicao
              ...
              .map((item) => (
              <div
                className={`prototype-residentes-legal-distribution-row${item.fixa ? " is-locked" : ""}`}
                key={`${item.fixa ? "atual" : "nova"}-${item.id}-${item.orgao || "vazio"}`}
              >
                <label>
                  <span>Órgão *</span>
                  {item.fixa ? (
                    <div className="prototype-residentes-legal-distribution-locked-orgao">
                    ...
                    <Dropdown
                      ...
                      showClear
                      filter
                      className="prototype-residentes-legal-distribution-dropdown"
                      onChange={(event) =>
                ...
                <div>
                  <span>Ações</span>
                  {item.fixa ? (
                    <span className="prototype-residentes-legal-distribution-locked-action">Fixo</span>
                  ) : (
                    <BotaoIconSeplag
                      type="button"
        ...
        {tipo === "REDISTRIBUICAO" && redistribuicaoIndisponivel && (
          <section className="prototype-residentes-legal-redistribution-version">
            <MensagemSeplag
              severity="info"
        ...
        {tipo === "REDISTRIBUICAO" && !redistribuicaoIndisponivel && (
          <section className="prototype-residentes-legal-redistribution-version">
            ...
            <div className="prototype-residentes-legal-redistribution-route">
              <article>
                <header>
                  <span className="prototype-residentes-legal-redistribution-icon is-origin">
              ...
              <div className="prototype-residentes-legal-redistribution-arrow" aria-hidden="true">
                <i className="pi pi-arrow-right" />
              </div>
              <article>
                <header>
                  <span className="prototype-residentes-legal-redistribution-icon is-destination">
            ...
            <div className="prototype-residentes-legal-redistribution-quantity">
              <NumberFieldSeplag
        ...
        {tipo === "REDUCAO" && (
          <section className="prototype-residentes-legal-reduction-allocation">
            <header>
              <div>
        ...
        {tipo === "TRANSFORMACAO" && (
          <section className="prototype-residentes-legal-reduction-allocation prototype-residentes-legal-transformation-allocation">
            <header>
              <div>
            ...
            <div className="prototype-residentes-legal-transformation-destination-field">
              <DropdownFieldSeplag
            ...
            {quadroDestino ? (
              <div className="prototype-residentes-legal-transformation-target">
        ...
        {tipo === "EXTINCAO_PROGRESSIVA" && (
          <section className="prototype-residentes-legal-extinction-guidance">
            <MensagemSeplag
              severity="info"
        ...
        )}        <div className="prototype-residentes-legal-fields prototype-residentes-legal-library-fields">
          <DateFieldSeplag
            name="dataEfeito"
            control={operacaoControl}
        ...
        />
        {tipo === "DISTRIBUICAO" && (
          <section className="prototype-residentes-legal-distribution-availability">
            <article>
              <span>Já distribuídas</span>
        ...
        <div className="prototype-residentes-legal-simulate-action">
          <BotaoSeplag
      ...
      {tipo === "DISTRIBUICAO" && distribuicaoSimulada && (
        <div className="prototype-residentes-legal-result">
          <header>
            <div>
          ...
          <section className="prototype-residentes-legal-transformation-balance">
          ...
          <section className="prototype-residentes-legal-distribution-simulation">
            <div>
      ...
      {resultado && tipo !== "ATUALIZACAO_BASE_LEGAL" && (
        <div className="prototype-residentes-legal-result">
          ...
          {tipo !== "TRANSFORMACAO" && tipo !== "ATUALIZACAO_BASE_LEGAL" && <div className="prototype-residentes-legal-result-kpis">
            {tipo === "AMPLIACAO" ? (
              <>
      ...
      {confirmacaoAberta && (resultado || distribuicaoSimulada || redistribuicaoSimulada) && (
        <div
          className="prototype-residentes-legal-confirm-backdrop"
          role="presentation"
          onMouseDown={() => setConfirmacaoAberta(false)}
        >
          <section
            className="prototype-residentes-legal-confirm"
            role="dialog"
            aria-modal="true"
