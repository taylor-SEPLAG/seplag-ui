...
function QuadroAutorizadoLista() {
  ...
  const celulaComEspecificacao = (
    ...
    item.id === filtrados[0]?.id ? (
      <SpecArea metadata={metadata}>
        <div className="prototype-residentes-quadro-spec-cell">{content}</div>
      </SpecArea>
    ) : (
      content
    );
  ...
  const columns: ColumnMetaSeplag<QuadroListaRow>[] = [
    {
      ...
      body: (item) =>
        celulaComEspecificacao(
          ...
          <div className="prototype-residentes-quadro-table-main">
            <button
              className="prototype-residentes-quadro-link"
      ...
      body: (item) =>
        celulaComEspecificacao(
          ...
          <div className="prototype-residentes-quadro-table-main">
            <button
              type="button"
              className="prototype-residentes-quadro-orgao-summary-button"
    ...
    },
    {
      ...
      body: (item) => {
        ...
        return (
          <SpecArea metadata={quadroColumnSpecifications.Situação}>
            <div className="prototype-residentes-quadro-spec-status">
              <BadgeSeplag
  ...
  const renderHistoricoVersoes = (item: QuadroListaRow) => {
    ...
    return (
      <SpecArea metadata={quadroColumnSpecifications["Histórico de versões"]}>
        <section className="prototype-residentes-quadro-version-history">
          {versoes.length ? (
            <>
              <div className="prototype-residentes-quadro-version-table-container">
                <table className="prototype-residentes-quadro-version-table">
                  <colgroup>
                    ...
                    {versoesPaginadas.map((versao) => {
                      ...
                      return (
                        <tr key={`${item.codigo}-${versao.versao}`}>
                          ...
                          <td>
                            <div className="prototype-residentes-quadro-actions">
                              <BotaoIconSeplag
                                type="button"
              ...
              <footer className="prototype-residentes-quadro-version-pagination">
                <Paginator
            ...
            <p className="prototype-residentes-quadro-version-empty">
  ...
  const renderControleHistorico = (item: QuadroListaRow) => {
    ...
    return (
      <SpecArea metadata={quadroColumnSpecifications["Histórico de versões"]}>
        <button
          type="button"
          className="prototype-residentes-quadro-expander"
          aria-label={
            aberto
  ...
  return (
    <SpecificationMode
      ...
      showViewToggles
    >
      <div className="prototype-residentes-quadro-page prototype-residentes-quadro-page-current">
        ...
        <section className="prototype-residentes-quadro-card">
          <div className="prototype-residentes-quadro-filters prototype-residentes-quadro-library-filters">
          ...
          <div className="prototype-residentes-quadro-table-toolbar">
          ...
          <SpecArea metadata={quadroTableSpecification}>
            <div className="prototype-residentes-quadro-table prototype-residentes-quadro-library-table">
        ...
        >
          <label className="prototype-residentes-quadro-delete-reason">
            <span>
...
function DistribuicaoOrgaosModal({
  ...
  return (
    <ModalSeplag
      ...
      customFooter={
        <div className="prototype-residentes-quadro-modal-library-actions">
          <BotaoVoltarSeplag
            label="Fechar"
            icon="pi pi-times"
            onClick={onClose}
    ...
    >
      <div className="col-12 prototype-residentes-quadro-distribution-modal">
        <header>
          <div>
        ...
        {quadro.distribuicaoOrgaos.length ? (
          <div className="prototype-residentes-quadro-distribution-modal-list">
...
function HistoricoVersaoModal({
  ...
  return (
    ...
    >
      <div className="col-12 prototype-residentes-quadro-version-modal">
        <div className="prototype-residentes-quadro-version-modal-status">
          <BadgeSeplag
            label={metaStatus.label}
            color={metaStatus.color}
            bg={metaStatus.bg}
...
function QuadroAutorizadoModal({
  ...
  return (
    <ModalSeplag
      ...
      titulo={
        <div>
          ...
          <small className="prototype-residentes-quadro-modal-library-subtitle">
    ...
    >
      <div className="col-12 prototype-residentes-quadro-modal-status">
        <SpecArea metadata={quadroColumnSpecifications.Situação}>
          <BadgeSeplag
            label={status.label}
            color={status.color}
      ...
      <div className="col-12 prototype-residentes-quadro-modal-body">
        <section>
          <h3>Identificação</h3>
          <dl>
            <div>
        ...
        <section>
          ...
          {!quantitativos.length && orgaosDoQuadro(registro).length > 1 && (
            <p className="prototype-residentes-quadro-modal-orgs">
...
function QuadroAutorizadoForm({
  ...
  return (
    <div className="prototype-residentes-quadro-page">
      ...
      />
      <form onSubmit={submit} className="prototype-residentes-quadro-form">
        <BaseLegalVinculada
            ...
            <DropdownFieldSeplag
              ...
              itemTemplate={(option) => (
                <span
                  className={
                    option.indisponivel
                      ? "prototype-residentes-quadro-cargo-indisponivel"
                      : undefined
                  }
                  aria-label={option.motivoIndisponibilidade || undefined}
                >
                  <span className="prototype-residentes-quadro-cargo-indisponivel-label">
                    {option.label}
                  </span>
                  {option.quadroCodigo && (
                    <span className="prototype-residentes-quadro-cargo-indisponivel-badge">
                      {option.quadroCodigo}
                    </span>
                  )}
                </span>
        ...
        <div className="prototype-residentes-quadro-form-paired">
        <section>
          <header>
          ...
          <div className="prototype-residentes-quadro-scope">
            <NumberFieldSeplag
              name="quantidade"
              control={control}
              label={
            ...
            />
            {novaVersao && (
              <div className="prototype-residentes-quadro-comparison">
        ...
        <section>
          ...
          <div className="prototype-residentes-quadro-library-section prototype-residentes-quadro-simple-vigencia">
            <div className="prototype-residentes-quadro-vigencia-date">
              <DateFieldSeplag
                name="dataAtivacao"
                control={control}
            ...
            <div className="prototype-residentes-quadro-simple-status" aria-live="polite">
              <i
                className={
                  "pi " +
                  (situacaoPrevia === "Agendado"
        ...
        <footer className="prototype-residentes-quadro-form-actions prototype-residentes-quadro-form-actions--flow">
          <BotaoVoltarSeplag
            label="Cancelar"
            icon="pi pi-times"
            onClick={onBack}
    ...
    <div className="prototype-residentes-quadro-page">
      <header className="prototype-residentes-quadro-header">
        <div>
          ...
          <div className="prototype-residentes-quadro-title-line">
            <h1>{registro.codigo}</h1>
            <span
              className={`prototype-residentes-quadro-status ${situacaoClass[situacao]}`}
            >
              {situacao}
            </span>
          </div>
        ...
        <div className="prototype-residentes-quadro-header-actions">
          ...
          {situacao === "Vigente" && (
            <button
              className="prototype-residentes-quadro-primary"
              onClick={() =>
                navigate(`${BASE_PATH}/${registro.id}/nova-versao`)
              }
            >
      ...
      <section className="prototype-residentes-quadro-detail-kpis">
        <article>
          <span>Autorizadas</span>
          <strong>{registro.autorizadas}</strong>
        </article>
      ...
      <div className="prototype-residentes-quadro-detail-grid">
        <section className="prototype-residentes-quadro-detail-card">
          <header>
      ...
      <section className="prototype-residentes-quadro-detail-card prototype-residentes-quadro-history">
        <header>
          <div>
          ...
          <tbody>
            ...
            {registro.versao > 1 && (
              <tr>
                ...
                <td>
                  <span className="prototype-residentes-quadro-status is-closed">
                    Substituída
                  </span>
                </td>
              </tr>
