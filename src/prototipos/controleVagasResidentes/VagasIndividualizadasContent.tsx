    ...
    () => [
      {
        ...
        body: (item) => (
          <div className="prototype-residentes-vaga-primary-cell">
            <button
              type="button"
              className="prototype-residentes-vaga-link"
      ...
      { header: "Órgão", field: "orgaoAtual" },
      {
        ...
        body: (item) => {
          ...
          return ocupacaoAtual ? (
            ...
            <span className="prototype-residentes-vaga-muted">Sem ocupante atual</span>
          );
        },
      },
      {
        ...
        body: (item) => {
          ...
          return compromisso ? (
            <span
              className={`prototype-residentes-vaga-commit ${compromisso.natureza.toLowerCase()}`}
            >
              <i className="pi pi-flag" />
              {faseAtual?.nome ?? "Aguardando análise"}
            </span>
          ) : ocupacaoAtual ? (
            <span className="prototype-residentes-vaga-state ocupada">
              <i className="pi pi-user" /> Em exercício
            </span>
          ) : (
            <span className="prototype-residentes-vaga-muted">Sem ingresso ativo</span>
          );
        },
      },
      {
        ...
        body: (item) => (
          <span
            className={`prototype-residentes-vaga-legal ${legalClass[item.situacaoLegal]}`}
          >
      ...
      <div className="prototype-residentes-vaga-page prototype-residentes-vaga-page-seplag">
        ...
        <section className="prototype-residentes-vaga-card prototype-residentes-vaga-card-seplag">
          <div className="prototype-residentes-vaga-filters-seplag">
            ...
            <div className="prototype-residentes-vaga-seplag-field prototype-residentes-vaga-clear">
          ...
          {quadroSelecionado ? (
            ...
            <div className="prototype-residentes-vaga-initial-state" role="status">
...
function VagasIndividualizadasLegacy() {
  ...
  return (
    <SpecificationMode
      ...
      businessItems={vagasBusinessItems}
    >
      <div className="prototype-residentes-vaga-page">
        <header className="prototype-residentes-vaga-header">
          <SpecArea metadata={vagasScreenSpecification}>
            <div>
              <h1>Vagas Individualizadas</h1>
        ...
        <section className="prototype-residentes-vaga-kpis">
          <Kpi
        ...
        <section className="prototype-residentes-vaga-card">
          <div className="prototype-residentes-vaga-filters">
            <SpecArea metadata={vagasFilterSpecifications.Identificador}>
              <label className="wide">
                <span>
                  ...
                  <button
                    type="button"
                    className="prototype-residentes-vaga-column-visibility"
          ...
          <SpecArea metadata={vagasBlockSpecifications.Tabela}>
            <div className="prototype-residentes-vaga-table">
              <table>
                <thead>
                  <tr>
                  ...
                  {exibidas.map((v) => {
                    ...
                    return (
                      <tr key={v.id}>
                        ...
                        {mostrarTipo && (
                          <td>
                            <span className="prototype-residentes-vaga-type">
                              {v.tipo === "EFETIVO"
                                ? "Efetivo"
                                : "Comissionado"}
                            </span>
                        ...
                        {mostrarEstado && (
                          <td>
                            <span
                              className={
                                "prototype-residentes-vaga-state " + v.estado.toLowerCase()
                              }
                            >
                              <i
                                className={
                        ...
                        {mostrarComprometimento && (
                          <td>
                            {compromisso ? (
                              <span
                                className={
                                  "prototype-residentes-vaga-commit " +
                        ...
                        {mostrarSituacaoLegal && (
                          <td>
                            <span
                              className={
                                "prototype-residentes-vaga-legal " +
                        ...
                        {mostrarLei && (
                          <td>
                            <span className="prototype-residentes-vaga-law">{v.lei}</span>
                          </td>
                        )}
                        <td>
                          <button
                            className="prototype-residentes-vaga-detail-button"
                            onClick={() => setVaga(v)}
          ...
          <SpecArea metadata={vagasActionSpecifications.Paginação}>
            <footer className="prototype-residentes-vaga-pagination">
              <Paginator
    ...
    <SpecArea metadata={vagasFilterSpecifications[label]}>
      <label>
        ...
        <Dropdown
          ...
          className="prototype-residentes-vaga-filter-dropdown"
    ...
    >
      <div className="col-12 prototype-residentes-vaga-detail-content">
        <div className="prototype-residentes-vaga-summary">
          <span className={`prototype-residentes-vaga-state ${vaga.estado.toLowerCase()}`}>
            <i
              className={
          ...
          <span
            className={`prototype-residentes-vaga-legal ${legalClass[vaga.situacaoLegal]}`}
          >
            {legalLabel[vaga.situacaoLegal]}
          </span>
        </div>
        <div className="prototype-residentes-vaga-detail-grid">
          <section>
        ...
        <section className="prototype-residentes-vaga-history">
          <header>
            <div>
...
function PosicaoFuncionalDaVaga({ vaga }: { vaga: Vaga }) {
  ...
  return (
    <>
      <section className="prototype-residentes-vaga-commitment-detail">
        <header>
          <div>
  ...
  return (
    <section className="prototype-residentes-vaga-commitment-detail">
      <header>
        ...
        <span
          className={"prototype-residentes-vaga-commit " + processo.natureza.toLowerCase()}
        >
          <i className="pi pi-flag" />
          {ativo
            ? "Em ocupação"
      ...
      <div className="prototype-residentes-vaga-commitment-progress">
        <span>
          <i
...
function OcupantesDaVaga({ vagaId }: { vagaId: string }) {
  ...
  return (
    <section className="prototype-residentes-vaga-occupants">
      <header>
