...
export function BreadcrumbVagas() {
  ...
  const base = "/prototipos/sigep/controle-vagas/residentes";
  ...
  return <div className="breadcrumb-vagas-residentes"><BreadcrumbSeplag divided homeTo="/prototipos/sigep" items={items} /></div>;
}
