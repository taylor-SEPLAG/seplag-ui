...
export function QuadroLegalOperacoes({ registro, onSaved }: { registro: QuadroAutorizadoRow; onSaved?: () => void }) {
  const { vagas } = useQuadroPessoalStore();
  ...
  const registrarNovaVersao = () => {
    ...
    const atual = quadroPessoalStore.getState();
    ...
    quadroPessoalStore.update((estado) => ({
      ...estado,
  ...
  return <section className="prototype-quadro-pessoal-legal-card">
