...
export function BreadcrumbVagas() {
  ...
  const items: BreadcrumbItemSeplag[] = [
    { label: "Controle de Vagas", to: "/prototipos/sigep/controle-vagas/dashboard" },
    { label: "Vagas Contratos Temporários", to: base },
  ];
  const telas: Record<string, string> = {
    ...
    cessoes: "Cessões",
    projecoes: "Projeções",
    "quadro-autorizado": "Quadro Contratos Temporários",
    vagas: "Vagas Contratos Temporários",
  };
  const tela = partes[0];
