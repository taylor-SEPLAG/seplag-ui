...
export function BaseLegalVinculada({
  ...
  return (
    <section className={`prototype-temporarios-base-legal-card ${className}`.trim()}>
      <header className="prototype-temporarios-base-legal-card__header">
      ...
      <div className="prototype-temporarios-base-legal-card__content">
