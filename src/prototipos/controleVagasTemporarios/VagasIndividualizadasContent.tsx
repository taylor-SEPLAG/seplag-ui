...
export function VagasIndividualizadasContent() {
    ...
    () => [
      {
        header: "Nome da vaga",
        body: (item) => (
          <div className="prototype-temporarios-vaga-primary-cell">
            <button
              type="button"
              className="prototype-temporarios-vaga-link"
      ...
      { header: "Órgão", field: "orgaoAtual" },
      {
        ...
        body: (item) => {
          ...
          return ocupacaoAtual ? (
            ...
            <span className="prototype-temporarios-vaga-muted">Sem ocupante atual</span>
          );
        },
      },
      {
        ...
        body: (item) => {
          ...
          return compromisso ? (
            <span
              className={`prototype-temporarios-vaga-commit ${compromisso.natureza.toLowerCase()}`}
            >
              <i className="pi pi-flag" />
              {faseAtual?.nome ?? "Aguardando análise"}
            </span>
          ) : ocupacaoAtual ? (
            <span className="prototype-temporarios-vaga-state ocupada">
              <i className="pi pi-user" /> Em exercício
            </span>
          ) : (
            <span className="prototype-temporarios-vaga-muted">Sem ingresso ativo</span>
          );
        },
      },
      {
        ...
        body: (item) => (
          <span
            className={`prototype-temporarios-vaga-legal ${legalClass[item.situacaoLegal]}`}
          >
  ...
  return (
    ...
    >
      <div className="prototype-temporarios-vaga-page prototype-temporarios-vaga-page-seplag">
        ...
        {quadroSelecionado && (
          <section className="prototype-temporarios-vaga-kpis prototype-temporarios-vaga-kpis-seplag">
            <Kpi
        ...
        <section className="prototype-temporarios-vaga-card prototype-temporarios-vaga-card-seplag">
          <div className="prototype-temporarios-vaga-filters-seplag">
            <div className="prototype-temporarios-vaga-seplag-field">
            ...
            <div className="prototype-temporarios-vaga-seplag-field prototype-temporarios-vaga-clear">
          ...
          {quadroSelecionado ? (
            <SpecArea metadata={vagasBlockSpecifications.Tabela}>
              <div className="prototype-temporarios-vaga-library-table">
...
function VagasIndividualizadasLegacy() {
  ...
  return (
    <SpecificationMode
      ...
      businessItems={vagasBusinessItems}
    >
      <div className="prototype-temporarios-vaga-page">
        <header className="prototype-temporarios-vaga-header">
          <SpecArea metadata={vagasScreenSpecification}>
            <div>
              <h1>Vagas Contratos Temporários</h1>
        ...
        <section className="prototype-temporarios-vaga-kpis">
          <Kpi
        ...
        <section className="prototype-temporarios-vaga-card">
          <div className="prototype-temporarios-vaga-filters">
            <SpecArea metadata={vagasFilterSpecifications.Identificador}>
              <label className="wide">
                <span>
                  ...
                  <button
                    type="button"
                    className="prototype-temporarios-vaga-column-visibility"
          ...
          <SpecArea metadata={vagasBlockSpecifications.Tabela}>
            <div className="prototype-temporarios-vaga-table">
              <table>
                <thead>
                  <tr>
                  ...
                  {exibidas.map((v) => {
                    ...
                    return (
                      <tr key={v.id}>
                        ...
                        {mostrarTipo && (
                          <td>
                            <span className="prototype-temporarios-vaga-type">
                              {v.tipo === "EFETIVO"
                                ? "Efetivo"
                                : "Comissionado"}
                            </span>
                        ...
                        {mostrarEstado && (
                          <td>
                            <span
                              className={
                                "prototype-temporarios-vaga-state " + v.estado.toLowerCase()
                              }
                            >
                              <i
                                className={
                        ...
                        {mostrarComprometimento && (
                          <td>
                            {compromisso ? (
                              <span
                                className={
                                  "prototype-temporarios-vaga-commit " +
                        ...
                        {mostrarSituacaoLegal && (
                          <td>
                            <span
                              className={
                                "prototype-temporarios-vaga-legal " +
                        ...
                        {mostrarLei && (
                          <td>
                            <span className="prototype-temporarios-vaga-law">{v.lei}</span>
                          </td>
                        )}
                        <td>
                          <button
                            className="prototype-temporarios-vaga-detail-button"
                            onClick={() => setVaga(v)}
          ...
          <SpecArea metadata={vagasActionSpecifications.Paginação}>
            <footer className="prototype-temporarios-vaga-pagination">
              <Paginator
    ...
    <SpecArea metadata={vagasFilterSpecifications[label]}>
      <label>
        ...
        <Dropdown
          ...
          className="prototype-temporarios-vaga-filter-dropdown"
...
function VagaDetalhe({ vaga, onClose }: { vaga: VagaIndividualizadaView; onClose: () => void }) {
  ...
  return (
    <ModalSeplag
      visible
      titulo={
        <div className="prototype-temporarios-vaga-modal-title">
    ...
    >
      <div className="col-12 prototype-temporarios-vaga-detail-content">
        <div className="prototype-temporarios-vaga-summary">
          <span className={`prototype-temporarios-vaga-state ${vaga.estado.toLowerCase()}`}>
            <i
              className={
          ...
          <span
            className={`prototype-temporarios-vaga-legal ${legalClass[vaga.situacaoLegal]}`}
          >
            {legalLabel[vaga.situacaoLegal]}
          </span>
        </div>
        <div className="prototype-temporarios-vaga-detail-grid">
          <section>
        ...
        <section className="prototype-temporarios-vaga-history">
          <header>
            <div>
...
function PosicaoFuncionalDaVaga({ vaga }: { vaga: Vaga }) {
  ...
  return (
    <>
      <section className="prototype-temporarios-vaga-commitment-detail">
        <header>
          <div>
  ...
  return (
    <section className="prototype-temporarios-vaga-commitment-detail">
      <header>
        ...
        <span
          className={"prototype-temporarios-vaga-commit " + processo.natureza.toLowerCase()}
        >
          <i className="pi pi-flag" />
          {ativo
            ? "Em ocupação"
      ...
      <div className="prototype-temporarios-vaga-commitment-progress">
        <span>
          <i
...
function OcupantesDaVaga({ vagaId }: { vagaId: string }) {
  ...
  return (
    <section className="prototype-temporarios-vaga-occupants">
      <header>
