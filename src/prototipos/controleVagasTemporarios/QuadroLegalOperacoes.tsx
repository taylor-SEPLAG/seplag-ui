...
const vagasElegiveisRedistribuicao =
  ...
  return (
    <section className="prototype-temporarios-legal-card">
      {versaoAgendada && (
        <MensagemSeplag
          severity="warning"
...
<form onSubmit={simular}>
        <section className="prototype-temporarios-legal-version-context">
          ...
          <dl className="prototype-temporarios-legal-version-summary">
        ...
        <BaseLegalVinculada
          className="prototype-temporarios-legal-documents"
        ...
        />
        <div className="prototype-temporarios-legal-types prototype-temporarios-legal-types-current">
        ...
        {tipo === "ATUALIZACAO_BASE_LEGAL" && (
          <section className="prototype-temporarios-legal-organization-change">
            <MensagemSeplag
              severity="info"
        ...
        {tipo === "DISTRIBUICAO" && (
          <section className="prototype-temporarios-legal-distribution-version">
            <header>
              <div>
            ...
            <div className="prototype-temporarios-legal-distribution-summary-inline">
            ...
            <div className="prototype-temporarios-legal-distribution-head">
              <span>Órgão *</span>
            ...
            {linhasDistribuicao
              ...
              .map((item) => (
              <div
                className={`prototype-temporarios-legal-distribution-row${item.fixa ? " is-locked" : ""}`}
                key={`${item.fixa ? "atual" : "nova"}-${item.id}-${item.orgao || "vazio"}`}
              >
                <label>
                  <span>Órgão *</span>
                  {item.fixa ? (
                    <div className="prototype-temporarios-legal-distribution-locked-orgao">
                    ...
                    <Dropdown
                      ...
                      showClear
                      filter
                      className="prototype-temporarios-legal-distribution-dropdown"
                      onChange={(event) =>
                ...
                <div>
                  <span>Ações</span>
                  {item.fixa ? (
                    <span className="prototype-temporarios-legal-distribution-locked-action">Fixo</span>
                  ) : (
                    <BotaoIconSeplag
                      type="button"
        ...
        {tipo === "REDISTRIBUICAO" && redistribuicaoIndisponivel && (
          <section className="prototype-temporarios-legal-redistribution-version">
            <MensagemSeplag
              severity="info"
        ...
        {tipo === "REDISTRIBUICAO" && !redistribuicaoIndisponivel && (
          <section className="prototype-temporarios-legal-redistribution-version">
            ...
            <div className="prototype-temporarios-legal-redistribution-route">
              <article>
                <header>
                  <span className="prototype-temporarios-legal-redistribution-icon is-origin">
              ...
              <div className="prototype-temporarios-legal-redistribution-arrow" aria-hidden="true">
                <i className="pi pi-arrow-right" />
              </div>
              <article>
                <header>
                  <span className="prototype-temporarios-legal-redistribution-icon is-destination">
            ...
            <div className="prototype-temporarios-legal-redistribution-quantity">
              <NumberFieldSeplag
        ...
        {tipo === "REDUCAO" && (
          <section className="prototype-temporarios-legal-reduction-allocation">
            <header>
              <div>
        ...
        {tipo === "TRANSFORMACAO" && (
          <section className="prototype-temporarios-legal-reduction-allocation prototype-temporarios-legal-transformation-allocation">
            <header>
              <div>
            ...
            <div className="prototype-temporarios-legal-transformation-destination-field">
              <DropdownFieldSeplag
            ...
            {quadroDestino ? (
              <div className="prototype-temporarios-legal-transformation-target">
        ...
        {tipo === "EXTINCAO_PROGRESSIVA" && (
          <section className="prototype-temporarios-legal-extinction-guidance">
            <MensagemSeplag
              severity="info"
        ...
        )}        <div className="prototype-temporarios-legal-fields prototype-temporarios-legal-library-fields">
          <DateFieldSeplag
            name="dataEfeito"
            control={operacaoControl}
        ...
        />
        {tipo === "DISTRIBUICAO" && (
          <section className="prototype-temporarios-legal-distribution-availability">
            <article>
              <span>Já distribuídas</span>
        ...
        <div className="prototype-temporarios-legal-simulate-action">
          <BotaoSeplag
      ...
      {tipo === "DISTRIBUICAO" && distribuicaoSimulada && (
        <div className="prototype-temporarios-legal-result">
          <header>
            <div>
          ...
          <section className="prototype-temporarios-legal-transformation-balance">
          ...
          <div className="prototype-temporarios-legal-result-kpis">
            <article>
              <span>Vagas elegíveis</span>
          ...
          <section className="prototype-temporarios-legal-distribution-simulation">
            <div>
      ...
      {resultado && tipo !== "ATUALIZACAO_BASE_LEGAL" && (
        <div className="prototype-temporarios-legal-result">
          ...
          {tipo !== "TRANSFORMACAO" && tipo !== "ATUALIZACAO_BASE_LEGAL" && <div className="prototype-temporarios-legal-result-kpis">
            {tipo === "AMPLIACAO" ? (
              <>
      ...
      {confirmacaoAberta && (resultado || distribuicaoSimulada || redistribuicaoSimulada) && (
        <div
          className="prototype-temporarios-legal-confirm-backdrop"
          role="presentation"
          onMouseDown={() => setConfirmacaoAberta(false)}
        >
          <section
            className="prototype-temporarios-legal-confirm"
            role="dialog"
            aria-modal="true"
