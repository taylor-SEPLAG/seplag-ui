...
export const quadroColumnSpecifications: Record<string, SpecificationMetadata> =
  {
    ...
    Disponíveis: spec(
      "CV-QA-COL-006",
      "Disponíveis",
      "Mostrar o saldo utilizável do quadro.",
      "máximo(0, autorizadas - ocupadas - comprometidas - bloqueadas).",
      "saldo derivado.",
      "integer",
      "TablePaginadoSeplag",
    ),
...
export const quadroActionSpecifications: Record<string, SpecificationMetadata> =
  {
    ...
    Editar: spec(
      ...
      "Permanece desabilitado quando o quadro já iniciou seus efeitos.",
    ),
    Excluir: spec(
      "CV-QA-ACT-005",
    ...
    Distribuir: spec(
      "CV-QA-ACT-006",
      "Distribuir vagas deste quadro",
      "Iniciar a destinação formal das vagas.",
      "Disponível enquanto o quadro produz efeitos; exige ato, processo SIGADOC e data de efeito.",
      "Quadro e vagas elegíveis.",
      "navigation",
      "BotaoIconSeplag",
      "/prototipos/sigep/controle-vagas/distribuicao?quadro=:id",
      "Abre a distribuição com o quadro de origem previamente selecionado.",
    ),
