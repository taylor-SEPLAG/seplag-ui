...
export const quadroActionSpecifications: Record<string, SpecificationMetadata> = {
  ...
  Distribuir: spec("CV-QA-ACT-006", "Distribuir vagas deste quadro", "Iniciar a destinação formal das vagas.", "Disponível para quadro vigente; exige ato, processo SIGADOC e data de efeito.", "Quadro e vagas elegíveis.", "navigation", "botão de estrutura", "/prototipos/sigep/controle-vagas/distribuicao"),
