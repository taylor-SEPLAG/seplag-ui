...
import type { CessaoFuncional, ComprometimentoVaga, ExcecaoJudicialVaga, FatorProjecaoVagas, MetodologiaProjecao, MovimentoVagaIndividual, OcupacaoVaga, QuadroAutorizadoRow, RegraEvento, TaxaEvasaoHistorica, Vaga } from "./types";
export interface ControleVagasState{quadros:QuadroAutorizadoRow[];vagas:Vaga[];comprometimentos:ComprometimentoVaga[];ocupacoes:OcupacaoVaga[];cessoes:CessaoFuncional[];movimentos:MovimentoVagaIndividual[];excecoesJudiciais:ExcecaoJudicialVaga[];regras:RegraEvento[];pendenciasRegras:string[];fatoresProjecao:FatorProjecaoVagas[];metodologias:MetodologiaProjecao[];taxasEvasao:TaxaEvasaoHistorica[]}
...
let state:ControleVagasState={quadros:[...quadrosAutorizadosMock],vagas:[...vagasIndividualizadasMock],comprometimentos:[...comprometimentosVagasMock],ocupacoes:[...ocupacoesIniciais],cessoes:[...cessoesMock],movimentos:[...movimentosVagasIndividuaisMock],excecoesJudiciais:[...excecoesJudiciaisMock],regras:[...regrasControleVagasMock],pendenciasRegras:[...pendenciasRegrasMock],fatoresProjecao:[...fatoresProjecaoMock],metodologias:[...metodologiasProjecaoMock],taxasEvasao:[...taxasEvasaoMock]};const listeners=new Set<()=>void>();const emitir=()=>listeners.forEach((l)=>l());
