...
export function ControleVagasRegrasContent() {
  ...
  const confirmarRegra = (id: number) => {
    controleVagasStore.set("regras", (atuais) => atuais.map((regra) => regra.id === id ? { ...regra, validacao: "Confirmada" } : regra));
  ...
  return (
    <div className="prototype-vagas-rules-page">
      ...
      <section className="prototype-vagas-formula-card">
        ...
        <div className="prototype-vagas-formula-note"><i className="pi pi-shield" /><span>Comprometimento é uma flag de processo e não altera o estado Disponível/Ocupada.</span></div>
      </section>
      ...
      {aba === "dimensoes" && <section className="prototype-vagas-panel"><div className="prototype-vagas-panel-heading"><div><h2>Composição da chave de controle</h2><p>Cada vaga é individualizada e vinculada obrigatoriamente às dimensões legais abaixo.</p></div></div><div className="prototype-vagas-dimension-grid">
