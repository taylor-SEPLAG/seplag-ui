import{a as e,n as t,t as n}from"./jsx-runtime-ChuIQw48.js";import{s as r}from"./index-DyeHa39m.js";import{n as i,t as a}from"./DocPage-CHgTh2J-.js";var o=e(t(),1),s=n(),c=[{id:`sgi`,label:`SGI`,url:`#`,icon:`pi pi-briefcase`},{id:`siagro`,label:`SIAGRO`,url:`#`,icon:`pi pi-chart-bar`},{id:`portal`,label:`Portal`,url:`#`,icon:`pi pi-globe`}];function l(){let[e,t]=(0,o.useState)(!1),[n,a]=(0,o.useState)(`SGI`),[l,u]=(0,o.useState)(`HOMOLOGAÇÃO`),d=`import { AppTopbarSeplag } from "@seplag/ui-lib-react-18";
