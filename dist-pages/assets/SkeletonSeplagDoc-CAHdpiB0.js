import{a as e,n as t,t as n}from"./jsx-runtime-DZnDww7V.js";import{J as r}from"./index-BFzUNSgo.js";import{n as i,t as a}from"./DocPage-Jz1L0ZQP.js";var o=e(t(),1),s=n(),c=[`text`,`title`,`avatar`,`button`,`card`,`custom`];function l(){let[e,t]=(0,o.useState)(`text`),[n,a]=(0,o.useState)(3),[l,u]=(0,o.useState)(``),[d,f]=(0,o.useState)(``),[p,m]=(0,o.useState)(``),[h,g]=(0,o.useState)(``),[_,v]=(0,o.useState)(`0.5rem`),y=`import { SkeletonSeplag } from "@seplag/ui-lib-react-18";\n\n<SkeletonSeplag\n  ${[`variant="${e}"`,n===1?``:`lines={${n}}`,l?`width="${l}"`:``,d?`height="${d}"`:``,p?`size="${p}"`:``,h?`borderRadius="${h}"`:``,_===`0.5rem`?``:`gap="${_}"`].filter(Boolean).join(`
