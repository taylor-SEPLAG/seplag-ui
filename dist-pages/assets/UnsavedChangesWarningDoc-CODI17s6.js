import{a as e,n as t,t as n}from"./jsx-runtime-DZnDww7V.js";import{c as r}from"./Botao-Cjfxadf-.js";import{B as i,Z as a,g as o,h as s,m as c}from"./index-C2HNGO9s.js";import{t as l}from"./DocPage-Jz1L0ZQP.js";var u=e(t(),1),d=n(),f=()=>null;function p(){let{control:e,formState:t}=a({defaultValues:{nome:``}});o(t.isDirty);let{guard:n}=s();return(0,d.jsxs)(`div`,{className:`flex flex-column gap-3`,style:{width:`100%`},children:[(0,d.jsx)(`div`,{className:`grid`,style:{width:`100%`},children:(0,d.jsx)(i,{name:`nome`,control:e,label:`Nome (edite para marcar como dirty)`,placeholder:`Digite algo...`,cols:`12`,getFormErrorMessage:f})}),(0,d.jsx)(`div`,{className:`flex gap-2`,children:(0,d.jsx)(r,{label:`Navegar (protegido)`,icon:`pi pi-arrow-right`,onClick:()=>n(()=>alert(`Navegação permitida!`))})}),(0,d.jsxs)(`small`,{className:`text-500`,children:[`Estado do formulário:`,` `,(0,d.jsx)(`strong`,{children:t.isDirty?`com alterações`:`sem alterações`})]})]})}function m(){return(0,d.jsx)(c,{children:(0,d.jsx)(p,{})})}function h(){let{setDirty:e,guard:t}=s(),[n,i]=(0,u.useState)(!1);return(0,d.jsxs)(`div`,{className:`flex flex-column gap-3`,children:[(0,d.jsxs)(`div`,{className:`flex gap-2 align-items-center`,children:[(0,d.jsx)(r,{label:n?`Limpar alterações`:`Simular alteração`,icon:n?`pi pi-times`:`pi pi-pencil`,onClick:()=>{let t=!n;i(t),e(t)}}),(0,d.jsx)(r,{label:`Ação protegida`,icon:`pi pi-shield`,onClick:()=>t(()=>alert(`Ação executada!`))})]}),(0,d.jsxs)(`small`,{className:`text-500`,children:[`Estado:`,` `,(0,d.jsx)(`strong`,{children:n?`com alterações`:`sem alterações`})]})]})}function g(){return(0,d.jsx)(c,{children:(0,d.jsx)(h,{})})}var _=[{title:`Com formulário react-hook-form`,description:`Use useUnsavedChangesSyncSeplag para sincronizar automaticamente o isDirty do useForm com o provider. Edite o campo e clique no botão para ver o modal de confirmação.`,example:(0,d.jsx)(m,{}),code:`// 1. Envolva a aplicação (ou a rota) com o Provider
import {
