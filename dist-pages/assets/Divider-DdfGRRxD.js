import{a as e,n as t,t as n}from"./jsx-runtime--AOyvnT1.js";import{P as r,s as i,x as a}from"./hooks.esm-DR260yFp.js";import{n as o,t as s}from"./componentbase.esm-BD9euHfT.js";import{t as c}from"./Grid-4oIljrRy.js";var l=e(t()),u=s.extend({defaultProps:{__TYPE:`Divider`,align:null,layout:`horizontal`,type:`solid`,style:null,className:null,children:void 0},css:{classes:{root:function(e){var t=e.props,n=e.horizontal,i=e.vertical;return r(`p-divider p-component p-divider-${t.layout} p-divider-${t.type}`,{"p-divider-left":n&&(!t.align||t.align===`left`),"p-divider-right":n&&t.align===`right`,"p-divider-center":n&&t.align===`center`||i&&(!t.align||t.align===`center`),"p-divider-top":i&&t.align===`top`,"p-divider-bottom":i&&t.align===`bottom`},t.className)},content:`p-divider-content`},styles:`
@layer primereact {
