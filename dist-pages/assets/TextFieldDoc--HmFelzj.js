import{a as e,n as t,t as n}from"./jsx-runtime-DZnDww7V.js";import{t as r}from"./button.esm-Cb4wl_s-.js";import{B as i,Z as a}from"./index-BFzUNSgo.js";import{t as o}from"./DocPage-Jz1L0ZQP.js";var s=e(t(),1),c=n(),l=()=>null;function u(){let{control:e}=a({defaultValues:{nome:``,codigo:``}});return(0,c.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,c.jsx)(i,{name:`nome`,control:e,label:`Nome`,placeholder:`Digite o nome`,cols:`12 6`,getFormErrorMessage:l}),(0,c.jsx)(i,{name:`codigo`,control:e,label:`Código (somente letras/números)`,placeholder:`Ex: ABC123`,cols:`12 6`,allowNumberLetter:!0,getFormErrorMessage:l})]})}function d(){let{control:e,handleSubmit:t}=a({defaultValues:{nomeObrigatorio:``,campoDesabilitado:`Valor fixo`}});return(0,c.jsxs)(`form`,{className:`grid`,style:{width:`100%`},onSubmit:t(()=>{}),children:[(0,c.jsx)(i,{name:`nomeObrigatorio`,control:e,label:`Nome (obrigatório)`,placeholder:`Obrigatório — clique em Validar sem preencher`,cols:`12 6`,required:!0,getFormErrorMessage:l}),(0,c.jsx)(i,{name:`campoDesabilitado`,control:e,label:`Desabilitado`,cols:`12 6`,disabled:!0,getFormErrorMessage:l}),(0,c.jsx)(`div`,{className:`col-12`,children:(0,c.jsx)(r,{type:`submit`,label:`Validar`,size:`small`})})]})}function f(){let{control:e,handleSubmit:t}=a({defaultValues:{cpf:``,cnpj:``},mode:`onTouched`});return(0,c.jsxs)(`form`,{className:`grid`,style:{width:`100%`},onSubmit:t(()=>{}),children:[(0,c.jsx)(i,{name:`cpf`,control:e,label:`CPF`,placeholder:`Somente números, 11 dígitos`,cols:`12 6`,numbersOnly:!0,maxLength:11,rules:{validate:e=>/^\d{11}$/.test(e)||`CPF deve conter exatamente 11 dígitos`},getFormErrorMessage:l}),(0,c.jsx)(i,{name:`cnpj`,control:e,label:`CNPJ`,placeholder:`Somente números, 14 dígitos`,cols:`12 6`,numbersOnly:!0,maxLength:14,rules:{validate:{formato:e=>/^\d{14}$/.test(e)||`CNPJ deve conter exatamente 14 dígitos`,naoZeros:e=>e!==`00000000000000`||`CNPJ não pode ser somente zeros`}},getFormErrorMessage:l}),(0,c.jsx)(`div`,{className:`col-12`,children:(0,c.jsx)(r,{type:`submit`,label:`Validar`,size:`small`})})]})}function p(){let{control:e,handleSubmit:t}=a({defaultValues:{codigo:``,email:``},mode:`onTouched`});return(0,c.jsxs)(`form`,{className:`grid`,style:{width:`100%`},onSubmit:t(()=>{}),children:[(0,c.jsx)(i,{name:`codigo`,control:e,label:`Código (5–10 caracteres, maiúsculas e números)`,placeholder:`Ex: ABC12`,cols:`12 6`,required:!0,rules:{minLength:{value:5,message:`Mínimo 5 caracteres`},maxLength:{value:10,message:`Máximo 10 caracteres`},validate:e=>/^[A-Z0-9]+$/.test(e)||`Apenas maiúsculas e números`},getFormErrorMessage:l}),(0,c.jsx)(i,{name:`email`,control:e,label:`E-mail`,placeholder:`usuario@exemplo.com`,cols:`12 6`,required:!0,rules:{validate:e=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)||`E-mail inválido`},getFormErrorMessage:l}),(0,c.jsx)(`div`,{className:`col-12`,children:(0,c.jsx)(r,{type:`submit`,label:`Validar`,size:`small`})})]})}function m(){let[e,t]=(0,s.useState)(``),[n,r]=(0,s.useState)(``);return(0,c.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,c.jsx)(i,{name:`telefone`,label:`Telefone (somente números)`,value:e,onChange:t,numbersOnly:!0,maxLength:11,cols:`12 6`,placeholder:`Ex: 31999999999`}),(0,c.jsx)(i,{name:`placa`,label:`Placa (sem espaços)`,value:n,onChange:r,noSpaces:!0,maxLength:7,cols:`12 6`,placeholder:`Ex: ABC1234`})]})}var h=[{title:`Uso básico`,description:`Campo de texto integrado com react-hook-form. O campo recebe control do useForm e exibe rótulo SEPLAG.`,example:(0,c.jsx)(u,{}),code:`import { useForm } from "react-hook-form";
