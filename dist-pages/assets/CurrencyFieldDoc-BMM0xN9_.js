import{t as e}from"./jsx-runtime-DZnDww7V.js";import{E as t,Z as n}from"./index-BFzUNSgo.js";import{t as r}from"./DocPage-Jz1L0ZQP.js";var i=e(),a=()=>null;function o(){let{control:e}=n({defaultValues:{salario:null,desconto:null}});return(0,i.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,i.jsx)(t,{name:`salario`,control:e,label:`Salário`,cols:`12 6`,getFormErrorMessage:a}),(0,i.jsx)(t,{name:`desconto`,control:e,label:`Desconto (obrigatório)`,cols:`12 6`,required:!0,getFormErrorMessage:a})]})}var s=[{title:`Uso básico`,description:`Campo de valor monetário em BRL com formatação automática.`,example:(0,i.jsx)(o,{}),code:`import { useForm } from "react-hook-form";
