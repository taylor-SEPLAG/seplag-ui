import{t as e}from"./jsx-runtime-DZnDww7V.js";import{A as t,B as n,F as r,L as i,N as a,P as o,R as s,V as c,Z as l,k as u,z as d}from"./index-C2HNGO9s.js";import{t as f}from"./DocPage-Jz1L0ZQP.js";var p=e(),m=()=>null;function h(){let{control:e}=l({defaultValues:{nome:``,email:``,descricao:``}});return(0,p.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,p.jsx)(n,{name:`nome`,control:e,label:`Nome`,placeholder:`Digite o nome`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(i,{name:`email`,control:e,label:`E-mail`,placeholder:`email@seplag.mt.gov.br`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(d,{name:`descricao`,control:e,label:`Descrição`,placeholder:`Descreva...`,cols:`12`,getFormErrorMessage:m})]})}function g(){let{control:e}=l({defaultValues:{quantidade:0,cpf:``,cnpj:``,telefone:``}});return(0,p.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,p.jsx)(o,{name:`quantidade`,control:e,label:`Quantidade`,cols:`12 4`,getFormErrorMessage:m}),(0,p.jsx)(u,{name:`cpf`,control:e,label:`CPF`,cols:`12 4`,getFormErrorMessage:m}),(0,p.jsx)(t,{name:`cnpj`,control:e,label:`CNPJ`,cols:`12 4`,getFormErrorMessage:m}),(0,p.jsx)(a,{name:`telefone`,control:e,label:`Telefone`,mask:`(99) 99999-9999`,cols:`12 4`,getFormErrorMessage:m})]})}function _(){let{control:e}=l({defaultValues:{uf:null,nascimento:null,ativo:!1}});return(0,p.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,p.jsx)(s,{name:`uf`,control:e,label:`UF`,options:[{label:`Mato Grosso`,value:`MT`},{label:`São Paulo`,value:`SP`},{label:`Rio de Janeiro`,value:`RJ`}],optionLabel:`label`,optionValue:`value`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(c,{name:`nascimento`,control:e,label:`Data de Nascimento`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(r,{name:`ativo`,control:e,label:`Ativo`,cols:`12`,getFormErrorMessage:m})]})}var v=[{title:`Campos de texto`,description:`TextField, EmailField e TextAreaField — todos integrados com react-hook-form e Rótulo SEPLAG.`,example:(0,p.jsx)(h,{}),code:`import { useForm } from "react-hook-form";
import {
  TextFieldSeplag,
  EmailFieldSeplag,
  TextAreaFieldSeplag,
