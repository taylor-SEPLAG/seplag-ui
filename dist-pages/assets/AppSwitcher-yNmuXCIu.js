...
`}});function q(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function oe(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]==null?{}:arguments[t];t%2?q(Object(n),!0).forEach(function(t){z(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):q(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}var J=b.forwardRef(function(e,t){var n=te(),h=b.useContext(m),g=K.getProps(e,h),x=G(b.useState(!1),2),S=x[0],C=x[1],w=K.setMetaData({props:g,state:{visible:S}}),T=w.ptm,E=w.cx;w.sx;var D=w.isUnstyled;re(K.css.styles,D,{name:`overlaypanel`});var O=b.useRef(``),k=b.useRef(null),A=b.useRef(null),j=b.useRef(!1),M=b.useRef(null),N=b.useRef(null),P=G(f({target:A,overlay:k,listener:function(e,t){var n=t.type;t.valid&&(n===`outside`?(g.dismissable&&!j.current&&Y(),j.current=!1):h.hideOverlaysOnDocumentScrolling?Y():o.isDocument(e.target)||$())},when:S}),2),I=P[0],L=P[1],R=S&&g.closeOnEscape,z=ee(`overlay-panel`,R);c({callback:function(){Y()},when:R&&z,priority:[p.OVERLAY_PANEL,z]});var B=function(e){return k&&k.current&&!(k.current.isSameNode(e)||k.current.contains(e))},V=function(e,t){return A.current!=null&&A.current!==(t||e.currentTarget||e.target)},H=function(e){Y(),e.preventDefault()},U=function(e){j.current=!0,v.emit(`overlay-click`,{originalEvent:e,target:A.current})},W=function(){j.current=!0},q=function(e,t){S?(Y(),V(e,t)&&(A.current=t||e.currentTarget||e.target,setTimeout(function(){J(e,A.current)},200))):J(e,t)},J=function(e,t){A.current=t||e.currentTarget||e.target,S?$():(C(!0),N.current=function(e){!B(e.target)&&(j.current=!0)},v.on(`overlay-click`,N.current))},Y=function(){C(!1),v.off(`overlay-click`,N.current),N.current=null},X=function(){k.current.setAttribute(O.current,``),a.set(`overlay`,k.current,h&&h.autoZIndex||l.autoZIndex,h&&h.zIndex.overlay||l.zIndex.overlay),o.addStyles(k.current,{position:`absolute`,top:`0`,left:`0`}),$()},Z=function(){I(),g.onShow&&g.onShow()},Q=function(){L()},se=function(){a.clear(k.current),g.onHide&&g.onHide()},$=function(){if(A.current&&k.current){o.absolutePosition(k.current,A.current);var e=o.getOffset(k.current),t=o.getOffset(A.current),n=0;e.left<t.left&&(n=t.left-e.left),k.current.style.setProperty(`--overlayArrowLeft`,`${n}px`),e.top<t.top?(k.current.setAttribute(`data-p-overlaypanel-flipped`,`true`),D&&o.addClass(k.current,`p-overlaypanel-flipped`)):(k.current.setAttribute(`data-p-overlaypanel-flipped`,`false`),D&&o.removeClass(k.current,`p-overlaypanel-flipped`))}},ce=function(){if(!M.current){M.current=o.createInlineStyle(h&&h.nonce||l.nonce,h&&h.styleContainer);var e=``;for(var t in g.breakpoints)e+=`
                    @media screen and (max-width: ${t}) {
                        .p-overlaypanel[${O.current}] {
                            width: ${g.breakpoints[t]};
                        }
                    }
                `;M.current.innerHTML=e}};u(function(){O.current=i(),g.breakpoints&&ce()}),d(function(){M.current=o.removeInlineStyle(M.current),N.current&&=(v.off(`overlay-click`,N.current),null),a.clear(k.current)}),b.useImperativeHandle(t,function(){return{props:g,toggle:q,show:J,hide:Y,align:$,isVisible:function(){return S},getElement:function(){return k.current}}});var le=function(){var e=n({className:E(`closeIcon`),"aria-hidden":!0},T(`closeIcon`)),t=g.closeIcon||b.createElement(y,e),i=r.getJSXIcon(t,oe({},e),{props:g}),a=n({type:`button`,className:E(`closeButton`),onClick:function(e){return H(e)},"aria-label":g.ariaCloseLabel||ne(`close`)},T(`closeButton`));return g.showCloseIcon?b.createElement(`button`,a,i,b.createElement(_,null)):null},ue=function(){var e=le(),t=n({id:g.id,className:s(g.className,E(`root`,{context:h})),style:g.style,onClick:function(e){return U(e)}},K.getOtherProps(g),T(`root`)),r=n({className:E(`content`),onClick:function(e){return W()},onMouseDown:W},K.getOtherProps(g),T(`content`)),i=n({classNames:E(`transition`),in:S,timeout:{enter:120,exit:100},options:g.transitionOptions,unmountOnExit:!0,onEnter:X,onEntered:Z,onExit:Q,onExited:se},T(`transition`));return b.createElement(ae,F({nodeRef:k},i),b.createElement(`div`,F({ref:k},t),b.createElement(`div`,r,g.children),e))}();return b.createElement(ie,{element:ue,appendTo:g.appendTo})});J.displayName=`OverlayPanel`;function Y(e){return N({tag:`svg`,attr:{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`},child:[{tag:`path`,attr:{d:`M5 5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M12 5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M19 5m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M5 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M19 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M5 19m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M12 19m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]},{tag:`path`,attr:{d:`M19 19m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0`},child:[]}]})(e)}var X={"app-switcher":`_app-switcher_1ux87_1`,"app-switcher__btn":`_app-switcher__btn_1ux87_11`,"app-switcher__panel":`_app-switcher__panel_1ux87_25`,"app-switcher__grid":`_app-switcher__grid_1ux87_51`,"app-switcher__item":`_app-switcher__item_1ux87_69`,"app-switcher__item_selected":`_app-switcher__item_selected_1ux87_103`,"app-switcher__iconWrap":`_app-switcher__iconWrap_1ux87_137`,"app-switcher__img":`_app-switcher__img_1ux87_157`,"app-switcher__label":`_app-switcher__label_1ux87_173`},Z=n(),Q=({currentSystem:e,items:t,className:n})=>{let r=(0,b.useRef)(null),i=(0,b.useMemo)(()=>(t??[]).filter(e=>e?.id&&e?.label&&e?.url).slice(),[t]);function a(e){r.current?.toggle(e)}function o(e){r.current?.hide(),(e.target??`_self`)===`_blank`?globalThis.open(e.url,`_blank`,`noopener,noreferrer`):globalThis.location.assign(e.url)}return(0,Z.jsxs)(`div`,{className:`${X[`app-switcher`]} ${n??``}`,children:[(0,Z.jsx)(g,{type:`button`,className:`${X[`app-switcher__btn`]}`,icon:(0,Z.jsx)(Y,{size:32}),tooltipOptions:{position:`bottom`},onClick:a}),(0,Z.jsx)(J,{ref:r,className:X[`app-switcher__panel`],dismissable:!0,appendTo:document.body,children:(0,Z.jsx)(`div`,{className:X[`app-switcher__grid`],role:`menu`,children:i.map(t=>(0,Z.jsxs)(`button`,{type:`button`,className:`${X[`app-switcher__item`]} ${t.label===e?X[`app-switcher__item_selected`]:``}`,onClick:()=>o(t),children:[(0,Z.jsx)(`div`,{className:X[`app-switcher__iconWrap`],children:typeof t.icon==`string`?(0,Z.jsx)(`i`,{className:`${X[`app-switcher__img`]} ${t.icon}`}):t.icon}),(0,Z.jsx)(`div`,{className:X[`app-switcher__label`],children:t.label})]},t.id))})})]})};export{N as n,Q as t};