import{t as e}from"./jsx-runtime-ChuIQw48.js";import{A as t,K as n}from"./index-DyeHa39m.js";import{t as r}from"./DocPage-CHgTh2J-.js";var i=e(),a=()=>null;function o(){let{control:e}=n({defaultValues:{email:``,emailInst:``}});return(0,i.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,i.jsx)(t,{name:`email`,control:e,label:`E-mail`,placeholder:`usuario@dominio.com`,cols:`12 6`,getFormErrorMessage:a}),(0,i.jsx)(t,{name:`emailInst`,control:e,label:`E-mail institucional (obrigatório)`,placeholder:`usuario@seplag.mt.gov.br`,cols:`12 6`,required:!0,getFormErrorMessage:a})]})}var s=[{title:`Uso básico`,description:`Campo de e-mail com validação de formato automática e remoção de espaços.`,example:(0,i.jsx)(o,{}),code:`import { useForm } from "react-hook-form";
