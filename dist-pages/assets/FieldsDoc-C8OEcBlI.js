import{t as e}from"./jsx-runtime--AOyvnT1.js";/* empty css              */import{r as t}from"./checkbox.esm-4xavqYZ-.js";import{_ as n,c as r,d as i,f as a,g as o,h as s,l as c,u as l,v as u,y as d}from"./Fields-DvUfwV1i.js";import{t as f}from"./DocPage-DfNa9OED.js";var p=e(),m=()=>null;function h(){let{control:e}=t({defaultValues:{nome:``,email:``,descricao:``}});return(0,p.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,p.jsx)(u,{name:`nome`,control:e,label:`Nome`,placeholder:`Digite o nome`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(s,{name:`email`,control:e,label:`E-mail`,placeholder:`email@seplag.mt.gov.br`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(n,{name:`descricao`,control:e,label:`Descrição`,placeholder:`Descreva...`,cols:`12`,getFormErrorMessage:m})]})}function g(){let{control:e}=t({defaultValues:{quantidade:0,cpf:``,cnpj:``,telefone:``}});return(0,p.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,p.jsx)(i,{name:`quantidade`,control:e,label:`Quantidade`,cols:`12 4`,getFormErrorMessage:m}),(0,p.jsx)(r,{name:`cpf`,control:e,label:`CPF`,cols:`12 4`,getFormErrorMessage:m}),(0,p.jsx)(c,{name:`cnpj`,control:e,label:`CNPJ`,cols:`12 4`,getFormErrorMessage:m}),(0,p.jsx)(l,{name:`telefone`,control:e,label:`Telefone`,mask:`(99) 99999-9999`,cols:`12 4`,getFormErrorMessage:m})]})}function _(){let{control:e}=t({defaultValues:{uf:null,nascimento:null,ativo:!1}});return(0,p.jsxs)(`div`,{className:`grid`,style:{width:`100%`},children:[(0,p.jsx)(o,{name:`uf`,control:e,label:`UF`,options:[{label:`Mato Grosso`,value:`MT`},{label:`São Paulo`,value:`SP`},{label:`Rio de Janeiro`,value:`RJ`}],optionLabel:`label`,optionValue:`value`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(d,{name:`nascimento`,control:e,label:`Data de Nascimento`,cols:`12 6`,getFormErrorMessage:m}),(0,p.jsx)(a,{name:`ativo`,control:e,label:`Ativo`,cols:`12`,getFormErrorMessage:m})]})}var v=[{title:`Campos de texto`,description:`TextField, EmailField e TextAreaField — todos integrados com react-hook-form e Rótulo SEPLAG.`,example:(0,p.jsx)(h,{}),code:`import { useForm } from "react-hook-form";
import {
  TextFieldSeplag,
  EmailFieldSeplag,
  TextAreaFieldSeplag,
