import{a as e,n as t,t as n}from"./jsx-runtime-DZnDww7V.js";import{T as r,Z as i}from"./index-DhqC7dUY.js";import{t as a}from"./DocPage-Jz1L0ZQP.js";var o=e(t(),1),s=n(),c=()=>null,l=[{id:1,nome:`Ana Silva`},{id:2,nome:`Bruno Costa`},{id:3,nome:`Carlos Souza`},{id:4,nome:`Diana Ferreira`},{id:5,nome:`Eduardo Lima`}];function u(){let{control:e}=i({defaultValues:{pessoa:``}}),[t,n]=(0,o.useState)([]);return(0,s.jsx)(`div`,{className:`grid`,style:{width:`100%`},children:(0,s.jsx)(r,{name:`pessoa`,control:e,label:`Pesquisar Pessoa`,placeholder:`Digite ao menos 1 caractere...`,fieldLabel:`nome`,items:t,minLength:1,search:e=>{let t=l.filter(t=>t.nome.toLowerCase().includes(e.toLowerCase()));n(t)},cols:`12 6`,getFormErrorMessage:c})})}var d=[{title:`Uso básico`,description:`AutoComplete com busca assíncrona. Chame search para carregar as sugestões.`,example:(0,s.jsx)(u,{}),code:`import { useState } from "react";
